...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('content', null, []); ?> 
        <h3 class="text-lg font-medium text-gray-900">
            <!-- __BLOCK__ --><?php if($this->enabled): ?>
                <!-- __BLOCK__ --><?php if($showingConfirmation): ?>
        ...
        <!-- __BLOCK__ --><?php if($this->enabled): ?>
            <!-- __BLOCK__ --><?php if($showingQrCode): ?>
...
<?php endif; ?>
            ...
            <!-- __BLOCK__ --><?php if($showingRecoveryCodes): ?>
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                ...
                <div class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm bg-gray-100 rounded-lg">
                    <!-- __BLOCK__ --><?php $__currentLoopData = json_decode(decrypt($this->user->two_factor_recovery_codes), true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH D:\laragon\www\foodmarket-bb\resources\views/profile/two-factor-authentication-form.blade.php ENDPATH**/ ?>