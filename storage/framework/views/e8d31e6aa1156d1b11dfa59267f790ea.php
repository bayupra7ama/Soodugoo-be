    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-5">
                ...
                <a href="<?php echo e(route('users.create')); ?>" class="bg-green-700 btn">
                   + Create User
                </a>
            </div>
            <div class="bg-white">
                <table class="table-auto w-full">
                    ...
                    <tbody>
                       ...
                       <tr>
                        ...
                        <td class="border px-6 py-4"><?php echo e($data->email); ?></td>
                        <td class="border px-6 py-4"><?php echo e($data->roles); ?></td>
                        <td class="border px-6 py-4 text-center"><a  href="<?php echo e(Route('users.edit',$data->id)); ?>">Edit | </a>
                        <form action="<?php echo e(Route('users.destroy',$data->id)); ?>" method="POST" class="inline-block">
            ...
            <div class="text-center mt-5"><?php echo e(($user->links())); ?></div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\foodmarket-bb\resources\views\users\index.blade.php ENDPATH**/ ?>